...
public class AcademicDetailBean {
	...
	public String toString() {
		return "AcademicDetailBean [sscMarks=" + sscMarks + ", sscTotalMarks=" + sscTotalMarks + ", hscMarks="
	...
	public AcademicDetailBean(int sscMarks, int sscTotalMarks, int hscMarks, int hscTotalMarks, int diplomaMarks,
